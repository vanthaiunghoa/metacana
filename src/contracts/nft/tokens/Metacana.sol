 ...
 */
contract MetacanaAssets is ERC1155MintBurnPackedBalance, ERC1155Metadata, ERC2981Global, Ownable {
  ...
  constructor (address _firstOwner) ERC1155Metadata("Metacana", "") Ownable(_firstOwner) public {}
