...
contract Conquest is IERC1155TokenReceiver, TieredOwnable {
  ...
  /**
   * @notice Link factories and metacana assets, store initial parameters
  ...
  {
    require(msg.sender == address(metacanaAssets), "Conquest#entry: INVALID_ENTRY_TOKEN_ADDRESS");
    ...
    // Burn tickets
    metacanaAssets.burn(conquestEntryID, 10**ENTRIES_DECIMALS);
