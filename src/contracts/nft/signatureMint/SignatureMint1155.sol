...
import { ProtocolControl } from "../../utils/ProtocolControl.sol";
    ...
    Multicall
{
    ...
    function mintWithSignature(MintRequest calldata _req, bytes calldata _signature) external payable override nonReentrant {
