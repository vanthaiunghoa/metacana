...
interface LootBoxRandomnessInterface extends ethers.utils.Interface {
  functions: {};
...
export class LootBoxRandomness extends Contract {
  ...
  filters: {
    ...
    Warning(
      message: null,
      account: null
    ): TypedEventFilter<[string, string], { message: string; account: string }>;
  };
