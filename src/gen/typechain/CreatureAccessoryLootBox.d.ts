...
interface CreatureAccessoryLootBoxInterface extends ethers.utils.Interface {
  functions: {
...
export class CreatureAccessoryLootBox extends Contract {
  ...
  functions: {
    ...
    "setOptionSettings(uint256,uint256,uint16[],uint16[])"(
      _option: BigNumberish,
      _maxQuantityPerOpen: BigNumberish,
      _classProbabilities: BigNumberish[],
      _guarantees: BigNumberish[],
    ...
    "setState(address,uint256,uint256,uint256)"(
      _factoryAddress: string,
      _numOptions: BigNumberish,
      _numClasses: BigNumberish,
      _seed: BigNumberish,
    ...
    "setTokenIdsForClass(uint256,uint256[])"(
      _classId: BigNumberish,
      _tokenIds: BigNumberish[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    "unpack(uint256,address,uint256)"(
      _optionId: BigNumberish,
      _toAddress: string,
      _amount: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
