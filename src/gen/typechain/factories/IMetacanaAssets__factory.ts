...
import type { IMetacanaAssets } from "../IMetacanaAssets";

export class IMetacanaAssets__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IMetacanaAssets {
    return new Contract(address, _abi, signerOrProvider) as IMetacanaAssets;
  }
}
